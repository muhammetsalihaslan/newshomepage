  ...
  return (
    <div className="flex mt-10 h-[140px]">
      <div className="flex-1 flex ">
        <Image src="/images/image-retro-pcs.jpg" width={100} height={110} />
        <div>
      ...
      <div className="flex-1 flex ">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-300 p-2">02</h1>
          <h1 className="font-bold text-black p-2">Top 10 Laptops of 2022</h1>
          <p className="text-sm p-2 text-slate-400">
      ...
      <div className="flex-1 flex ">
        ...
        <div>
          <h1 className="text-3xl font-bold text-slate-300 p-2">03</h1>
          <h1 className="font-bold text-black p-2">The Growth of Gaming</h1>
          <p className="text-sm p-2 text-slate-400">
